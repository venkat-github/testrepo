...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/user.html").hasAuthority(AuthoritiesConstants.USER)
            .antMatchers("/doctor.html").hasAuthority(AuthoritiesConstants.DOCTOR)
            .antMatchers("/admin.html").hasAuthority(AuthoritiesConstants.ADMIN)
            .antMatchers("/hospital.html").hasAuthority(AuthoritiesConstants.HOSPITAL)
